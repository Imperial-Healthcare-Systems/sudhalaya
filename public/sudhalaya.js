...
const CAT_ICONS = {
  all:  `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3.5 8.5h17l-1.3 9.4a2.2 2.2 0 0 1-2.2 1.9H7a2.2 2.2 0 0 1-2.2-1.9L3.5 8.5z"/><path d="M8 8.5a4 4 0 0 1 8 0"/><path d="M9.3 11.7l.4 4.6M14.7 11.7l-.4 4.6M12 11.7v4.6"/></svg>`,
  dairy:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M6.6 9.2c1.1-.7 1.6-1.2 1.6-2.2h7.6c0 1 .5 1.5 1.6 2.2 1.1.7 1.6 2 1.6 3.9C19 17 16 19.5 12 19.5S5 17 5 13.1c0-1.9.5-3.2 1.6-3.9z"/><path d="M8.2 7V5.4a1 1 0 0 1 1-1h5.6a1 1 0 0 1 1 1V7"/><path d="M8.6 13.2h6.8"/><path d="M9.8 15.4h4.4"/></svg>`,
  oil:  `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M10 4h4v1.9l1.3 1.9a3.2 3.2 0 0 1 .7 2V18.4A1.6 1.6 0 0 1 14.4 20H9.6A1.6 1.6 0 0 1 8 18.4V9.8a3.2 3.2 0 0 1 .7-2L10 5.9V4z"/><path d="M9.5 4h5"/><path d="M12 11.6c1 1.1 1.7 2 1.7 2.9a1.7 1.7 0 0 1-3.4 0c0-.9.7-1.8 1.7-2.9z" fill="currentColor" stroke="none"/></svg>`,
  honey:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="6.4" y="8" width="11.2" height="12" rx="2.2"/><path d="M6.4 11.4c2 1.3 4-1 5.6 0s3.6 1.3 5.6 0"/><path d="M9.2 8V6h5.6v2"/><path d="M12 3.4V6"/></svg>`,
  grain:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20V7.5"/><path d="M12 8c-.3-2.2-1.8-3.7-4-4.2.4 2.2 1.9 3.7 4 4.2zM12 8c.3-2.2 1.8-3.7 4-4.2-.4 2.2-1.9 3.7-4 4.2z"/><path d="M12 13c-.3-1.8-1.6-3-3.5-3.4.3 1.8 1.6 3 3.5 3.4zM12 13c.3-1.8 1.6-3 3.5-3.4-.3 1.8-1.6 3-3.5 3.4z"/><path d="M12 17.5c-.3-1.8-1.6-3-3.5-3.4.3 1.8 1.6 3 3.5 3.4zM12 17.5c.3-1.8 1.6-3 3.5-3.4-.3 1.8-1.6 3-3.5 3.4z"/></svg>`,
